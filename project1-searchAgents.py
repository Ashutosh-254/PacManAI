    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextposition[0]][nextposition[1]]:
                ...
                newstate = (nextposition, tuple(nextVisitedCorners))
...
def cornersHeuristic(state, problem):
    ...
    manhattandistance = [util.manhattanDistance(pacmanposition, corner) for corner in unvisitedcorners]
    
    costofheuristic = max(manhattandistance)
...
def foodHeuristic(state, problem):
    ...
    for i in range(len(foodlist)):
        for j in range(i + 1, len(foodlist)):
            ...
            if distance > farthestfooddistance:
                farthestfooddistance = distance

    total = closestfooddistance + farthestfooddistance
    return total
